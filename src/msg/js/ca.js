...
Blockly.Msg.ANALOG_JOYSTICK = "Joystick analògic";
Blockly.Msg.ANALOG_PINS = "pin analògic";
...
Blockly.Msg.CAN_EXT = "extès";
Blockly.Msg.CAN_FRAME_ALREADY_EXISTS = "Ja existeix un paquet anomenat '%1'.";
Blockly.Msg.CAN_FRAME_CANCEL = "Cancel·lar";
Blockly.Msg.CAN_FRAME_CANNOT_REMOVE = "Aquest paquet no es pot esborrar.";
Blockly.Msg.CAN_FRAME_CANNOT_RENAME = "Aquest paquet no permer canviar el nom.";
Blockly.Msg.CAN_FRAME_CREATE = "Crear paquet ...";
Blockly.Msg.CAN_FRAME_NAME = "Nom del paquet";
Blockly.Msg.CAN_GET = "obtenir";
Blockly.Msg.CAN_GET_D0 = "dada 0";
Blockly.Msg.CAN_GET_D1 = "dada 1";
Blockly.Msg.CAN_GET_D2 = "dada 2";
Blockly.Msg.CAN_GET_D3 = "dada 3";
Blockly.Msg.CAN_GET_D4 = "dada 4";
Blockly.Msg.CAN_GET_D5 = "dada 5";
Blockly.Msg.CAN_GET_D6 = "dada 6";
Blockly.Msg.CAN_GET_D7 = "dada 7";
Blockly.Msg.CAN_GET_FROM_FRAME = "de";
Blockly.Msg.CAN_GET_HELPURL = "Obté el valor d'un camp d'un paquet CAN.";
Blockly.Msg.CAN_GET_IDENTIFIER = "identificador";
Blockly.Msg.CAN_GET_LEN = "mida";
Blockly.Msg.CAN_GET_TOOLTIP = "";
Blockly.Msg.CAN_GET_TO_FRAME = "cap a";
Blockly.Msg.CAN_GET_TYPE = "tipus";
Blockly.Msg.CAN_READ = "llegir des de";
Blockly.Msg.CAN_READ_HELPURL = "";
Blockly.Msg.CAN_READ_TOOLTIP = "Llegeix un paquet des del CAN bus.";
Blockly.Msg.CAN_SET = "estableix";
Blockly.Msg.CAN_SET_D0 = "dada 0";
Blockly.Msg.CAN_SET_D1 = "dada 1";
Blockly.Msg.CAN_SET_D2 = "dada 2";
Blockly.Msg.CAN_SET_D3 = "dada 3";
Blockly.Msg.CAN_SET_D4 = "dada 4";
Blockly.Msg.CAN_SET_D5 = "dada 5";
Blockly.Msg.CAN_SET_D6 = "dada 6";
Blockly.Msg.CAN_SET_D7 = "dada 7";
Blockly.Msg.CAN_SET_FILTER = "estableix filtre per a";
Blockly.Msg.CAN_SET_FILTER_FROM = "des de";
Blockly.Msg.CAN_SET_FILTER_HELPURL = "Estableix un filtre. Només els paquets amb un identificador que compleix el filtre són acceptats.";
Blockly.Msg.CAN_SET_FILTER_TO = "fins a";
Blockly.Msg.CAN_SET_FILTER_TOOLTIP = "";
Blockly.Msg.CAN_SET_HELPURL = "Estableix el valor d'un camp per a un paquet CAN a un determinat valor.";
Blockly.Msg.CAN_SET_IDENTIFIER = "identificador";
Blockly.Msg.CAN_SET_LEN = "mida";
Blockly.Msg.CAN_SET_SPEED = "estableix velocitat per";
Blockly.Msg.CAN_SET_SPEED_HELPURL = "";
Blockly.Msg.CAN_SET_SPEED_TOOLTIP = "Estableix la velocitat del CAN bus.";
Blockly.Msg.CAN_SET_TOOLTIP = "";
Blockly.Msg.CAN_SET_TO_FRAME = "per al paquet";
Blockly.Msg.CAN_SET_TO_VALUE = "valor";
Blockly.Msg.CAN_SET_TYPE = "tipus";
Blockly.Msg.CAN_STD = "estàndard";
Blockly.Msg.CAN_TYPE_HELPURL = "";
Blockly.Msg.CAN_TYPE_TOOLTIP = "";
Blockly.Msg.CAN_WRITE = "escriure cap a";
Blockly.Msg.CAN_WRITE_FRAME = "paquet";
Blockly.Msg.CAN_WRITE_HELPURL = "Envia un paquet al CAN bus.";
...
Blockly.Msg.EDIT_CAN_FRAME_TITLE = "Editar paquet ...";
...
Blockly.Msg.EVENT_EVERY_TOOLTIP = "Aquest bloc s'activa a intervals regulars de temps.";
...
Blockly.Msg.EVENT_WHEN_WIFI_IS_CONNECTED = "quan la Wi-Fi està connectada";
Blockly.Msg.EVENT_WHEN_WIFI_IS_CONNECTED_TOOLTIP = "Aquest bloc s'activarà quan la Wi-Fi es connecti.";
Blockly.Msg.EVENT_WHEN_WIFI_IS_DISCONNECTED = "quan la Wi-Fi està desconnectada";
Blockly.Msg.EVENT_WHEN_WIFI_IS_DISCONNECTED_TOOLTIP = "Aquest bloc s'activarà quan la Wi-Fi es desconnecti.";
...
Blockly.Msg.FOREVER = "per sempre";
Blockly.Msg.FREQUENCY = "amb frecuencia";
Blockly.Msg.GPS = "GPS compatible amb NMEA";
Blockly.Msg.HALL_FLOW = "Flux de líquid per efecte hall";
...
Blockly.Msg.INTERNAL_HALL = "Sensor d'efecte hall intern";
Blockly.Msg.Khz = "Khz";
Blockly.Msg.LINEAR_POT = "Potenciòmetre lineal";
...
Blockly.Msg.LORA_ACTIVATION_DATA = "Dades d'activació del node:";
...
Blockly.Msg.LORA_GATEWAY = "Gateway monocanal";
Blockly.Msg.LORA_GET_ABP_DATA_HELP = "The Whitecat IDE ofereix als seus usuaris una aplicació TTN LoRa WAN per provar un node ABP. Si voleu utilitzar-lo, feu clic al botó 'Obtenir dades' per obtenir les dades de personalització.";
Blockly.Msg.LORA_GET_DATA = "Obtenir dades ...";
Blockly.Msg.LORA_GET_OTAA_DATA_HELP = "The Whitecat IDE ofereix als seus usuaris una aplicació TTN LoRa WAN per provar un node OTAA. Si voleu utilitzar-lo, feu clic al botó 'Obtenir dades' per obtenir les dades d'activació.";
...
Blockly.Msg.LORA_PERSONALIZATION_DATA = "Dades de personalització del node:";
Blockly.Msg.LORA_ROLE = "Rol";
Blockly.Msg.LORA_ROLE_GATEWAY_TITLE = "Configuració del gateway:";
Blockly.Msg.LORA_ROLE_NODE_TITLE = "Configuració bàsica del node:";
...
Blockly.Msg.LORA_START_GW = "iniciar gateway";
Blockly.Msg.LORA_STOP_GW = "aturar gateway";
...
Blockly.Msg.MQTT_GET_DATA = "Obtenir dades ...";
Blockly.Msg.MQTT_GET_DATA_HELP = "The Whitecat IDE ofereix als seus usuaris un broker MQTT amb finalitats de prova. Si voleu utilitzar-lo, feu clic al botó 'Obtenir dades' per obtenir les dades de la connexió.";
...
Blockly.Msg.MQTT_SUBSCRIBE = "quan es rebi un missatge del tòpic";
Blockly.Msg.MQTT_TO_TOPIC = "al tòpic";
Blockly.Msg.NEW_CAN_FRAME = "Nou paquet ...";
Blockly.Msg.NEW_CAN_FRAME_TITLE = "Nou paquet ...";
...
Blockly.Msg.OUTPUT_PINS = "pin de sortida";
Blockly.Msg.PERCENT = "%";
...
Blockly.Msg.REL_ROT_ENCODER = "Encoder rotatori relatiu";
Blockly.Msg.REMOVE_COMMENT = "Elimina el comentari";
Blockly.Msg.REMOVE_SENSOR = "Eliminar sensor ...";
Blockly.Msg.RENAME_CAN_FRAME = "Canviar el nom del paquet...";
...
Blockly.Msg.SENSOR_INT_ATTACHED = "%1 connectat a";
...
Blockly.Msg.WARNING_RAISE_ERROR_AGAIN_NOT_ALLOWED_HERE = "Advertència: Aquest bloc només es pot utilitzar dins un bloc 'prova captura finalment' en la seva part captura.";
...
Blockly.Msg.illuminance = "Il·luminació";
Blockly.Msg.invertdigitalpin = "inverteix valor pin digital";
Blockly.Msg.liquid_flow = "Flux de líquid";
...
Blockly.Msg.potentiometers = "Potenciòmetres";
Blockly.Msg.presence = "Presència";
Blockly.Msg.pressure = "Pressió";
Blockly.Msg.read = "llegir";
Blockly.Msg.rotation = "Rotació";
Blockly.Msg.seconds = "segons";
Blockly.Msg.setdigitalpin = "establir valor pin digital";
Blockly.Msg.setpwmpin = "estableix pin PWM";
Blockly.Msg.soil_moisture = "Humitat del sol";
