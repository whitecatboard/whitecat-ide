...
Blockly.Msg.FREQUENCY = "con frecuencia de";
Blockly.Msg.HELP = "Ayuda";
Blockly.Msg.HERTZS = "hercios";
Blockly.Msg.HIGH = "alto";
Blockly.Msg.INITIALDUTY = "con duty inicial de";
...
Blockly.Msg.SENSOR = "Modelo de sensor";
Blockly.Msg.SENSOR_ACQUIRE = "obtener datos de %1";
...
Blockly.Msg.SENSOR_ANALOG_PIN = "El sensor está en el pin analógico";
Blockly.Msg.SENSOR_CANCEL = "Cancelar";
Blockly.Msg.SENSOR_CREATE = "Crear";
Blockly.Msg.SENSOR_DEFAULT_NAME = "sensor";
Blockly.Msg.SENSOR_DIGITAL_PIN = "El sensor está en pin digital";
Blockly.Msg.SENSOR_NAME = "Nombre de este sensor en tu entorn de trabajo";
Blockly.Msg.SENSOR_READ1 = "leer ";
Blockly.Msg.SENSOR_READ2 = " desde %1";
...
Blockly.Msg.SENSOR_SET3 = " para %1 ";
...
Blockly.Msg.WITHNEWVALUE = "con nuevo valor";
...
Blockly.Msg.pwmsetduty = "establecer valor DUTY en pin PWM";
Blockly.Msg.pwmstart = "arrancar PWM en pin";
Blockly.Msg.pwmstop = "parar PWM en pin";
Blockly.Msg.pwmwrite = "escribir valor PWM en pin";
