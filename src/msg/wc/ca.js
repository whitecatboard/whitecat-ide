var MSG = {
  ...
  alert: "Atenció",
  pleaseUpgradeAgent: "Hi ha una nova versió de The Whitecat Create Agent. Si us plau, actualitzi a la nova versió, per assegurar el correcte funcionament de The Whitecat IDE.<br><br><button type=\"button\" class=\"btn btn-success btn-alert-instructions\" data-url=\"wiki/alerts/whitecat-create-agent/How-to-update\">Obrir les instruccions per actualitzar ...</button>",
  thisFuntionRequiresUpdateAgent: "Aquesta funció requereix una nova versió de The Whitecat Create Agent. <br><br><button type=\"button\" class=\"btn btn-success btn-alert-instructions\" data-url=\"wiki/alerts/whitecat-create-agent/How-to-update\">Obrir les instruccions per actualitzar ...</button>",
