...
<div class="input-prepend">
	...
	<input {if $FIELD_MODEL->isReadOnly2()}disabled{/if} id="{$MODULE}_editView_fieldName_{$FIELD_NAME}" type="text" class="input-medium" data-validation-engine="validate[{if $FIELD_MODEL->isMandatory() eq true} required,{/if}funcCall[Vtiger_Base_Validator_Js.invokeValidation]]" name="{$FIELD_MODEL->getFieldName()}"
