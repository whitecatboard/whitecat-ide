...
Blockly.FieldSensor.prototype.onItemSelected = function(menu, menuItem) {
  ...
  if (this.sourceBlock_) {
    ...
    if (this.renameSensorItemIndex_ >= 0 &&
        menu.getChildAt(this.renameSensorItemIndex_) === menuItem) {
      // Rename variable.
      ...
      return;
    } else if (this.deleteSensorItemIndex_ >= 0 &&
        menu.getChildAt(this.deleteSensorItemIndex_) === menuItem) {
      // Delete variable.
