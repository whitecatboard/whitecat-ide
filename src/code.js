...
Code.updateStatus = function() {
	...
	if (!Board.isConnected()) {
		...
		html += '</thead>';
		html += '<tbody>';
		html += '<tr><td>' + MSG['installedFirmware'] + '</td><td>' + Board.status.firmware + '</td></tr>';
		html += '<tr><td>' + MSG['cpuModel'] + '</td><td>' + Board.status.cpu + '</td></tr>';
		html += '</tbody>';
		html += '</table>';
		html += '</table>';
...
Code.checkFirmware = function() {
	Board.checkForNewFirmwareAvailability(Board.currentPort(),
